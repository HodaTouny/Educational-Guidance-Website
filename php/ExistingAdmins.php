...
<body>
    <div class="container">
        <h3 class="text-center py-4">All Existing Admins</h3>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td onclick='deleteUser(\"" . $row["email"] .  "\", this)' style='cursor:pointer;'> <svg xmlns='http://www.w3.org/2000/svg' enable-background='new 0 0 60 60' viewBox='0 0 60 60' id='delete'><path d='M18.3,56h23.6c2.7,0,4.8-2.2,4.8-4.8V18.7h2.1c0.6,0,1-0.4,1-1v-2.3c0-2.1-1.7-3.7-3.7-3.7h-8.5V9.1c0-1.7-1.4-3.1-3.1-3.1
